...
export default async function Page({params}) {
  ...
  return (
    <div className='my-4 pb-2 rounded-lg shadow h-[20rem] w-56 mx-auto'>
      <div className=''>
        <Image src = {`/imagenes/vehiculos/${vehiculo.tipo.imagen}`} alt = '' height = {100} width = {180} className='rounded-t-l-lg sm:rounded-t-lg object-fill w-56'/>
