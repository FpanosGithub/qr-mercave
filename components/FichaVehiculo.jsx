...
export default function FichaVehiculo ({vehiculo}) {
  return(
  <div className='my-2 pb-4 border border-gray-200 rounded-lg shadow h-[24rem] w-72 mx-auto'>
    <div className=''>
      ...
      <div className='flex flex-col justify-between mb-2'>
        <div className="text-center mt-2 p-1 text-xl text-gray-800 truncate">{vehiculo.num_uic}</div>
        <div className="text-center text-xl text-gray-500 truncate">{vehiculo.keeper}</div>
        <div className="text-center mb-2 text-xl text-gray-500">{vehiculo.tipo.descripcion}</div>
      </div>
    </div>
